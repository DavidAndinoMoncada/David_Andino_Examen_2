            ...
            try
            {
                ...
                using (MySqlConnection _conexion = new MySqlConnection(cadena))
                {
                    ...
                    using (MySqlCommand _comando = new MySqlCommand(sql.ToString(), _conexion))
                    {
                        ...
                        _comando.Parameters.Add("@Identidad", MySqlDbType.VarChar, 30).Value = identidad;
        ...
        public DataTable DevolverClientesPorNombre(string nombre)
        {
            ...
            try
            {
                ...
                using (MySqlConnection _conexion = new MySqlConnection(cadena))
                {
                    ...
                    {
                        _comando.CommandType = CommandType.Text;
                        _comando.Parameters.Add("@Nombre", MySqlDbType.VarChar, 30).Value = nombre;
                        MySqlDataReader dr = _comando.ExecuteReader();
                        dt.Load(dr);
        ...
        public bool Insertar(Cliente cliente)
        {
            ...
            try
            {
                ...
                using (MySqlConnection _conexion = new MySqlConnection(cadena))
                {
                    ...
                    {
                        _comando.CommandType = CommandType.Text;
                        _comando.Parameters.Add("@Identidad", MySqlDbType.VarChar, 30).Value = cliente.Identidad;
                        _comando.Parameters.Add("@Nombre", MySqlDbType.VarChar, 30).Value = cliente.Nombre;
                        _comando.Parameters.Add("@Telefono", MySqlDbType.VarChar, 30).Value = cliente.Telefono;
                        _comando.Parameters.Add("@Correo", MySqlDbType.VarChar, 30).Value = cliente.Correo;
                        _comando.Parameters.Add("@Direccion", MySqlDbType.VarChar, 30).Value = cliente.Direccion;
