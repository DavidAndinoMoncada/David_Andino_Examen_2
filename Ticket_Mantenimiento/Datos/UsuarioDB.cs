    ...
    public class UsuarioDB
    {
        ...
        public bool Insertar(Usuario user)
        {
            ...
            try
            {
                ...
                sql.Append("(@CodigoUsuario, @Nombre, @Contraseña, @Correo, @Rol, @Foto, @EstaActivo);");
                ...
                using (MySqlConnection _conexion = new MySqlConnection(cadena))
                {
                    ...
                    using (MySqlCommand _comando = new MySqlCommand(sql.ToString(), _conexion))
                    {
                        ...
                        _comando.Parameters.Add("@Contraseña", MySqlDbType.VarChar, 50).Value = user.Contraseña;
                        _comando.Parameters.Add("@Correo", MySqlDbType.VarChar, 50).Value = user.Correo;
                        _comando.Parameters.Add("@Rol", MySqlDbType.VarChar, 50).Value = user.Rol;
